About xorg-util-macros-feedstock
================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/xorg-util-macros-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/xorg-util-macros-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add xorg-util-macros
# for installing globally
pixi global install xorg-util-macros
```
...
It is possible to list all of the versions of `xorg-util-macros` available on your platform:
...
```
pixi search xorg-util-macros --channel conda-forge
```
